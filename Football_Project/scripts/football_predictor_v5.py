...
# ══════════════════════════════════════════════════════
#  DATA TAMBAHAN — ditambahkan manual (tidak di notebook)
# ══════════════════════════════════════════════════════

PLAYER_RATINGS = {'FC Barcelona': {'Yamal': {'pos': 'RW', 'rating': 0.95}, 'Lewandowski': {'pos': 'ST', 'rating': 0.92}, 'Pedri': {'pos': 'CM', 'rating': 0.9}, 'Raphinha': {'pos': 'LW', 'rating': 0.88}, 'De Jong': {'pos': 'CM', 'rating': 0.87}, 'Ter Stegen': {'pos': 'GK', 'rating': 0.9}, 'Kounde': {'pos': 'CB', 'rating': 0.83}, 'Araujo': {'pos': 'CB', 'rating': 0.85}, 'Balde': {'pos': 'LB', 'rating': 0.8}}, 'Real Madrid CF': {'Vinicius': {'pos': 'LW', 'rating': 0.95}, 'Mbappe': {'pos': 'ST', 'rating': 0.95}, 'Bellingham': {'pos': 'AM', 'rating': 0.93}, 'Rodrygo': {'pos': 'RW', 'rating': 0.87}, 'Valverde': {'pos': 'CM', 'rating': 0.88}, 'Modric': {'pos': 'CM', 'rating': 0.82}, 'Courtois': {'pos': 'GK', 'rating': 0.93}, 'Militao': {'pos': 'CB', 'rating': 0.87}, 'Carvajal': {'pos': 'RB', 'rating': 0.85}}, 'Club Atlético de Madrid': {'Griezmann': {'pos': 'AM', 'rating': 0.9}, 'Morata': {'pos': 'ST', 'rating': 0.75}, 'Oblak': {'pos': 'GK', 'rating': 0.95}, 'De Paul': {'pos': 'CM', 'rating': 0.8}, 'Koke': {'pos': 'CM', 'rating': 0.75}, 'Savic': {'pos': 'CB', 'rating': 0.8}, 'Witsel': {'pos': 'CB', 'rating': 0.75}, 'Llorente': {'pos': 'RB', 'rating': 0.75}}, 'Villarreal CF': {'Danjuma': {'pos': 'LW', 'rating': 0.82}, 'Morales': {'pos': 'AM', 'rating': 0.8}, 'Baena': {'pos': 'CM', 'rating': 0.83}, 'Pepe Reina': {'pos': 'GK', 'rating': 0.75}, 'Albiol': {'pos': 'CB', 'rating': 0.8}, 'Capoue': {'pos': 'DM', 'rating': 0.78}, 'Yeremy': {'pos': 'RW', 'rating': 0.8}}, 'Real Betis Balompié': {'Fekir': {'pos': 'AM', 'rating': 0.87}, 'Isco': {'pos': 'AM', 'rating': 0.83}, 'William Carvalho': {'pos': 'DM', 'rating': 0.8}, 'Bravo': {'pos': 'GK', 'rating': 0.78}, 'Edgar': {'pos': 'CB', 'rating': 0.78}, 'Miranda': {'pos': 'CB', 'rating': 0.77}, 'Joaquin': {'pos': 'RW', 'rating': 0.75}}, 'RC Celta de Vigo': {'Aspas': {'pos': 'ST', 'rating': 0.9}, 'Beltran': {'pos': 'CM', 'rating': 0.8}, 'Tapia': {'pos': 'DM', 'rating': 0.78}, 'Marchesín': {'pos': 'GK', 'rating': 0.8}, 'Mingueza': {'pos': 'CB', 'rating': 0.77}, 'Lage': {'pos': 'LW', 'rating': 0.78}}, 'RCD Espanyol de Barcelona': {'Puado': {'pos': 'LW', 'rating': 0.8}, 'Calero': {'pos': 'CB', 'rating': 0.78}, 'Keidi Bare': {'pos': 'DM', 'rating': 0.77}, 'Lecomte': {'pos': 'GK', 'rating': 0.78}, 'Exposito': {'pos': 'AM', 'rating': 0.8}, 'Vidal': {'pos': 'CM', 'rating': 0.75}}, 'Real Sociedad de Fútbol': {'Oyarzabal': {'pos': 'ST', 'rating': 0.88}, 'Zubimendi': {'pos': 'DM', 'rating': 0.87}, 'Brais Mendez': {'pos': 'AM', 'rating': 0.83}, 'Remiro': {'pos': 'GK', 'rating': 0.85}, 'Le Normand': {'pos': 'CB', 'rating': 0.85}, 'Barrenetxea': {'pos': 'LW', 'rating': 0.8}}, 'Getafe CF': {'Borja Mayoral': {'pos': 'ST', 'rating': 0.85}, 'Arambarri': {'pos': 'DM', 'rating': 0.85}, 'Djene': {'pos': 'CB', 'rating': 0.8}, 'Greenwood': {'pos': 'RW', 'rating': 0.9}, 'David Soria': {'pos': 'GK', 'rating': 0.8}, 'Alderete': {'pos': 'CB', 'rating': 0.77}}, 'Athletic Club': {'Williams I': {'pos': 'ST', 'rating': 0.88}, 'Williams II': {'pos': 'LW', 'rating': 0.87}, 'Berenguer': {'pos': 'AM', 'rating': 0.8}, 'Unai Simon': {'pos': 'GK', 'rating': 0.87}, 'Yeray': {'pos': 'CB', 'rating': 0.83}, 'Dani Garcia': {'pos': 'DM', 'rating': 0.82}, 'De Marcos': {'pos': 'RB', 'rating': 0.78}}, 'CA Osasuna': {'Budimir': {'pos': 'ST', 'rating': 0.85}, 'Moncayola': {'pos': 'CM', 'rating': 0.8}, 'Herrera': {'pos': 'DM', 'rating': 0.78}, 'Sergio Herrera': {'pos': 'GK', 'rating': 0.82}, 'David Garcia': {'pos': 'CB', 'rating': 0.83}, 'Torró': {'pos': 'DM', 'rating': 0.77}}, 'Valencia CF': {'Duro': {'pos': 'ST', 'rating': 0.82}, 'Pepelu': {'pos': 'CM', 'rating': 0.83}, 'Guillamón': {'pos': 'DM', 'rating': 0.78}, 'Mamardashvili': {'pos': 'GK', 'rating': 0.88}, 'Diakhaby': {'pos': 'CB', 'rating': 0.8}, 'Gayà': {'pos': 'LB', 'rating': 0.82}}, 'Rayo Vallecano de Madrid': {'Falcao': {'pos': 'ST', 'rating': 0.8}, 'Oscar Trejo': {'pos': 'AM', 'rating': 0.8}, 'Catena': {'pos': 'CB', 'rating': 0.78}, 'Stole Dimitrievski': {'pos': 'GK', 'rating': 0.82}, 'Unai Lopez': {'pos': 'CM', 'rating': 0.78}, 'Nteka': {'pos': 'LW', 'rating': 0.77}}, 'Sevilla FC': {'En-Nesyri': {'pos': 'ST', 'rating': 0.85}, 'Rakitic': {'pos': 'CM', 'rating': 0.8}, 'Fernando': {'pos': 'DM', 'rating': 0.8}, 'Nyland': {'pos': 'GK', 'rating': 0.78}, 'Gudelj': {'pos': 'DM', 'rating': 0.78}, 'Badé': {'pos': 'CB', 'rating': 0.82}, 'Acuña': {'pos': 'LB', 'rating': 0.8}}, 'Girona FC': {'Dovbyk': {'pos': 'ST', 'rating': 0.88}, 'Savinho': {'pos': 'RW', 'rating': 0.87}, 'Aleix Garcia': {'pos': 'CM', 'rating': 0.85}, 'Gazzaniga': {'pos': 'GK', 'rating': 0.82}, 'Blind': {'pos': 'CB', 'rating': 0.8}, 'Tsygankov': {'pos': 'LW', 'rating': 0.82}}, 'Deportivo Alavés': {'Abde': {'pos': 'LW', 'rating': 0.82}, 'Toni Martinez': {'pos': 'ST', 'rating': 0.78}, 'Guridi': {'pos': 'CM', 'rating': 0.77}, 'Sivera': {'pos': 'GK', 'rating': 0.78}, 'Tenaglia': {'pos': 'RB', 'rating': 0.75}}, 'Elche CF': {'Boyé': {'pos': 'ST', 'rating': 0.8}, 'Mascarell': {'pos': 'DM', 'rating': 0.77}, 'Gumbau': {'pos': 'CM', 'rating': 0.76}, 'Badía': {'pos': 'GK', 'rating': 0.78}, 'Bigas': {'pos': 'CB', 'rating': 0.76}}, 'RCD Mallorca': {'Muriqi': {'pos': 'ST', 'rating': 0.85}, 'Dani Rodriguez': {'pos': 'RW', 'rating': 0.8}, 'Maffeo': {'pos': 'RB', 'rating': 0.78}, 'Greif': {'pos': 'GK', 'rating': 0.8}, 'Valjent': {'pos': 'CB', 'rating': 0.82}, 'Morlanes': {'pos': 'CM', 'rating': 0.77}}, 'Levante UD': {'Roger': {'pos': 'ST', 'rating': 0.8}, 'Campaña': {'pos': 'CM', 'rating': 0.8}, 'Radoja': {'pos': 'DM', 'rating': 0.77}, 'Koke Vegas': {'pos': 'GK', 'rating': 0.77}, 'Postigo': {'pos': 'CB', 'rating': 0.76}, 'Lerma': {'pos': 'DM', 'rating': 0.78}}, 'Real Oviedo': {'Borja Bastón': {'pos': 'ST', 'rating': 0.8}, 'Santi Cazorla': {'pos': 'AM', 'rating': 0.82}, 'Pombo': {'pos': 'CM', 'rating': 0.77}, 'Gaspar': {'pos': 'GK', 'rating': 0.76}, 'Costas': {'pos': 'CB', 'rating': 0.76}}}
...
2. Jalankan: exec(open("football_predictor_v5.py").read())
3. Set API keys:
   import os
   os.environ["API_FOOTBALL_KEY"] = "isi_key"
   os.environ["FD_API_KEY"]        = "isi_key"
4. Prediksi:
   predict_match("barcelona", "real madrid")
   predict_match("atletico", "getafe", home_absent=["Griezmann"])
"""
